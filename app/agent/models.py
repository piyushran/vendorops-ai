...
class AgentRun(Base):
    ...
    actor_id: Mapped[str] = mapped_column(String(255), nullable=False, default="unknown")
    tool_identity: Mapped[str] = mapped_column(String(255), nullable=False, default="unknown")
    action_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, default="unknown")
